...
func NewGraph(info *types.Info, recv *ast.FieldList, typ *ast.FuncType, body *ast.BlockStmt, forwardOnly bool) *Graph {
	buildIntervals := func() []graph.BlockInterval {
		return graph.BuildGraph(info, recv, typ, body, forwardOnly)
	}

...
func TestTargets(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			usage, _, _ := Usage(t.Context(), p, scopes, body, funcType, level.ScopeFull, level.ShadowOff, level.NestedOff)
			...
			// when
			cm.BlockMovesLosingTypeInfo(usage.Usages)

			mt := cm.SortedMoveTargets(nil)
